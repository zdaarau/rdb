...
c2d provides functions to access the C2D Database (https://c2d.ch) from R. This database aims to record all direct democratic votes worldwide and is operated by the Swiss Centre for Democracy Studies Aarau (ZDA).

...
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------|:-----------------------------|:---------------------------------------------------------|
| Hostname of the [RDB NocoDB server](https://admin.rdb.vote/). Used as default for the `*nococdb*()` family of functions.                                                                                 | `rdb.nocodb_hostname`      | `R_RDB_NOCODB_HOSTNAME`      |                                                          |
| NocoDB [API authentication token](https://docs.nocodb.com/account-settings/api-tokens/) for the [RDB NocoDB server](https://admin.rdb.vote/). Used as default for the `*nococdb*()` family of functions. | `rdb.nocodb_api_token`     | `R_RDB_NOCODB_API_TOKEN`     |                                                          |
| Title (name) of the main base on the [RDB NocoDB server](https://admin.rdb.vote/). Used as default for the `*nococdb*()` family of functions.                                                            | `rdb.nocodb_base_title`    | `R_RDB_NOCODB_BASE_TITLE`    | `"Main"`                                                 |

        ...
        c("### Tags",
          ...
          c2d:::data_tags %>% purrr::pmap_chr(~ paste0("- [", ..1, "]{.color-azure}",
                                                       ..2 %>%
                                                         ...
                                                         paste0(collapse = ""))),
          "",
          paste0("<sup>[`tags_tier_1`](#tags-tier-1){.color-azure} are colored in [azure]{.color-azure}, [`tags_tier_2`](#tags-tier-2){.color-violet} in ",
                 "[violet]{.color-violet} and [`tags_tier_3`](#tags-tier-3){.color-rose} in [rose]{.color-rose}.</sup>")[!strip_extended_pandoc],
          "",
...
c2d::data_codebook %>%
  dplyr::filter(stringr::str_detect(string = variable_name,
                                    pattern = "^inst_",
                                    negate = TRUE)) %>%
  cat_v_sections(strip_extended_pandoc = knitr::pandoc_to("gfm"))
```
...
```{r, footnotes, echo = FALSE, results = "asis", include = !knitr::pandoc_to("gfm")}
cat("

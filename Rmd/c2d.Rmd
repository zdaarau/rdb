...
-   [ ] Properly convert column `created_on` to type date.

-   [ ] Find out what `-2L` (and possibly other special values) means in integer columns and recode properly.

-   [ ] Implement getting partial results as soon as [internal issue \#11](https://github.com/ccmdesign/c2d-app/issues/11) is resolved.

NOTES:

-   The following values seem to be used for empty values:

    -   `-1L` in integer fields
    -   `""` in character fields

...
TODO: Upstream renamings and recodings as far as possible and subsequently remove them from `tidy_referendums()`, `assemble_query_filter()` and all other
affected places.
...
### Mandatory C2D referendum database fields
...
This maps the final variable names as found in the [C2D codebook](https://rpkg.dev/c2d/articles/codebook.html) to the field names of the back-end's MongoDB. The

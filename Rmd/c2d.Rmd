...
are ignored from package builds.
...
TODO: Check the `date_*_min/max` arguments for validity; create generic function for this (accepting either a numeric value in the valid datetime range or a
string signifying a date/datetime), ideally in pkg pal?
...
Finally, we have to save all the internal data objects to `R/sysdata.rda`.
  ...
  pkgpins::with_cache(.fn = ~ {
    ...
    data %<>%
      ...
      magrittr::set_names(names(.) %>% dplyr::recode("created_on" = "date_time_created",
                                                     ...
                                                     "vote_trigger_state_level" = "inst_trigger_state_level",
                                                     "vote_trigger_number" = "inst_trigger_threshold",
                                                     "vote_trigger_time" = "inst_trigger_time_limit",
                                                     "vote_trigger" = "inst_trigger_type",
                                                     "decision_quorum" = "inst_quorum_decision",
                                                     "turnout_quorum" = "inst_quorum_turnout",
                                                     "referendum_text_options" = "inst_referendum_text_options",
                                                     "institutional_precondition" = "inst_precondition",
                                                     "institutional_precondition_decision" = "inst_precondition_decision",
                                                     "institutional_precondition_decision_actor" = "inst_precondition_decision_actor",
                                                     "action" = "inst_action",
      ...
      dplyr::relocate(id,
                      ...
                      any_of("inst_degree_of_revision"),
                      any_of("inst_is_binding"),
                      any_of("inst_is_counter_proposal"),
                      any_of("inst_vote_venue"),
                      starts_with("inst_trigger_"),
                      any_of("inst_quorum_turnout"),
                      any_of("inst_quorum_decision"),
                      any_of("inst_referendum_text_options"),
                      any_of("inst_precondition"),
                      any_of("inst_precondition_decision"),
                      any_of("inst_precondition_decision_actor"),
                      any_of("inst_action"),
                      any_of("inst_vote_venue"),
                      any_of("inst_degree_of_revision"),
                      any_of("inst_topics_special"),

...
-   Determine mandatory fields (any at all?)
-   Check if order of JSON fields matters (shouldn't!).

``` {.curl}
curl 'https://services.c2d.ch/referendums' \
     --request POST \
     -H 'Content-Type: application/json' \
     -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI1YzhiYTE3ZDYxYWY4NDYyMmRkZThjNjEiLCJleHAiOjE2Mjg2MTU5NjN9.lH9x7m82HQG69biek5IRafiYUnA99nLn2WClp_YKIFk' \
     --data-raw $'{"draft":true,"title":{"en":"test salim 2","de":"","fr":""},"date":"2222-07-17","level":"Sub-national","country_name":"Switzerland","country_code":"CH","institution":"Citizens\' initiative","categories":{"vote_trigger":"Automatic","legal_act_type":"Normal","vote_trigger_actor":"Constitution","vote_trigger_state_level":"Equal","vote_trigger_number":"","vote_trigger_time":"","vote_object":"Legal text (ausformulierter vorschlag)","author_of_the_vote_object":"Parliament","counter_proposal":"No","action":["Abrogate","Introduce","Revise"],"vote_venue":"Ballot","official_status":"Official","vote_result_status":"","hierarchy_of_the_legal_norm":"Constitution","degree_of_revision":"Partial","turnout_quorum":"","decision_quorum":"Simple majority","referendum_text_options":"Whole text only","institutional_precondition":"Exists","institutional_precondition_decision":"Yes","institutional_precondition_decision_actor":"","special_topics":[],"excluded_topics":["Jus cogens"]},"votes_no":-1,"votes_yes":-1,"votes_empty":-1,"votes_invalid":-1,"total_electorate":-1,"citizens_abroad":-1,"result":"Unknown","tags":[],"files":[],"committee_name":"","remarks":"","canton":"Aargau"}'
```
...
-   The order of JSON fields doesn't matter.
...
curl 'https://services.c2d.ch/referendums/610005e2c72633da60229938' \
     ...
     --data-raw $'{"draft":true,"title":{"de":"salims cat test"},"categories":{"excluded_topics":[]}}'
```

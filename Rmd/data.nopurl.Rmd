...
-   ISO monetizes the standards itselves as well as derived datasets like the [Country Codes Collection](https://www.iso.org/publication/PUB500001.html) instead
    of offering open data APIs! 🤬 So most open-source projects including the R package source their ISO 3166 data from [Debian's `iso-codes`
    project](https://salsa.debian.org/iso-codes-team/iso-codes) which might lack behind official standard updates.

### `data_iso_3166_1`

ISO 3166-1 data, corrected and extended by unofficial information for countries which are not covered by the ISO standard yet.
...
data_iso_3166_1 <-
  ...
  dplyr::mutate(Common_name = dplyr::case_when(Alpha_2 == "CD" ~ "Congo",

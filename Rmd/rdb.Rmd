...
tbl_metadata <-
  tibble::tribble(
    ...
    "legal_norms",                  "#64d864",      "display",           "\u2712",          FALSE,
...
-   Disable schema edit for external PGSQL data source after NocoDB setup is complete via
    ...
    nocodb::data_srcs(id_base = id_base,
      ...
      purrr::chuck("id") |>
      nocodb::update_data_src(is_schema_readonly = TRUE,
                              id_base = id_base,
                              hostname = hostname,
                              email = email,
                              password = password)

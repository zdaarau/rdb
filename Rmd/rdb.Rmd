...
#' @param s3_endpoint S3-compatible endpoint URL where the object storage bucket to be cleaned `r pal::wrap_chr(s3_bucket_attachments, "\x60")` resides.
...
-   Use Fly.io and Backblaze B2 RESTful APIs instead of CLIs.

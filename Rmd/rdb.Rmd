...
-   The order of the tables corresponds to the desired order in the NocoDB UI, i.e. to re-order tables, simply move them up/down in `tbl_metadata` and run
    `rdb::config_nocodb()`.
...
-   implement PGSQL data backup -\> restore

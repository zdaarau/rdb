...
The Referendum Database (RDB) currently offers a [privately documented](https://github.com/zdaarau/c2d-app/blob/master/docs/services.md) API available under
...
-   `/referendums`: get data on multiple referendums
    ...
    -   In integer fields:
        ...
        -   `-2L` ([means "information not given"](https://github.com/zdaarau/c2d-app/issues/13#issuecomment-802466615), an *implicit* `NA`)
...
-   Fields that are stored as dates in MongoDB (`date_time_created`) [adhere](https://github.com/zdaarau/c2d-app/issues/13#issuecomment-802466615) to the
    ...
    code](https://github.com/zdaarau/c2d-app/commit/6b72d1928e0182f01b188f3973ba15482fc8c04a#diff-3ecba6be31877a5a2347c54e34b7afcc3e76575c6f6e194bcf70c336bdbe6075)
...
database, so we can't filter on it. It has [been requested](https://github.com/zdaarau/c2d-app/issues/20) to change this upstream.
...
[Before 2021-05-25](https://github.com/zdaarau/c2d-app/issues/10), the RDB API server didn't provide the [intermediate *R3*
...
Format 3) was the first one encountered, formats 1) and 2) [were encountered on the API's testing instance](https://github.com/zdaarau/c2d-app/issues/78).
...
-   `query_filter_date()` handles [custom processing](https://github.com/zdaarau/c2d-app/blob/6b72d1928e0182f01b188f3973ba15482fc8c04a/services.py#L1163-L1170),
    while `query_filter_datetime()` returns the native MongoDB datetime format.
...
-   The `context.*` fields are ignored unless `"country_code":"CH","level":"national"`, cf. [issue #52](https://github.com/zdaarau/c2d-app/issues/52).
...
-   [Currently](https://github.com/zdaarau/c2d-app/issues/50#issuecomment-1222660683), the following variables are mandatory even for edits:
...
title](https://github.com/zdaarau/c2d-app/blob/master/docs/services.md#3-referendum-routes).
...
#'
#' @param var_names Variable name(s) present in [`data_codebook`]. A character vector.
#'
#' @return A character vector of the same length as `var_names`.
...
-   Add better example which actually shows the difference between `country_code` and `country_code_continual`. To investigate: Why are there currently no
    rfrnds included in the RDB with ISO 3166-3 alpha-4 `country_code`s?

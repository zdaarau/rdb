...
-   Various base R methods like the `$` and `[[` extractor functions aren't implemented for `tbl_lazy` objects, so we have to rely on `dplyr::pull()` (which is
    implemented for `tbl_lazy`).

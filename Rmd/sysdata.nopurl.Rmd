...
pkg_config <-
  ...
  tibble::add_row(key = "pg_host",
                  default_value = list("ep-sparkling-voice-33039503.eu-central-1.aws.neon.tech"),
  ...
  tibble::add_row(key = "pg_username",
  ...
  tibble::add_row(key = "pg_password",
                  ...
                  description = "Password for the specified RDB PostgreSQL user.") |>
